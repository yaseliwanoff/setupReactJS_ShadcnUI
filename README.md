...
Современный стартовый шаблон для React проектов с использованием Vite, Tailwind CSS и Shadcn UI.
...
# Установка отдельного PostCSS плагина для Tailwind CSS
...
- ✅ Tailwind CSS с новым PostCSS плагином
